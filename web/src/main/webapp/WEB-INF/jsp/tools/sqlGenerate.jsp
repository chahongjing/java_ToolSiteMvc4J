                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4 miniGroup">
                            <span>
                                <select class="form-control"
                                        data-ng-options="item.value as item.name for item in model.dbTypes"
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4 miniGroup">
                            <span>
                                <select class="form-control"
                                        data-ng-options="item.value as item.name for item in model.operatorTypes"
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4 miniGroup">
                            <span>
                                <select class="form-control"
                                        data-ng-options="item.value as item.name for item in model.subjects"
                                        data-ng-model="model.selectedSubject">
                                </select>
                            </span>
                        </div>
                        <label class="col-md-2 col-sm-2 col-xs-2 control-label no-padding-right" class="form-control"
                               data-ng-bind="model.subjectName">
                        </label>
                        <div class="col-md-4 col-sm-4 col-xs-4 miniGroup">
                            <span>
                                <input class="form-control" type="text" data-ng-model="model.firstObj"
                                       onfocus="this.select();"
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4 miniGroup">
                            <span>
                                <select class="form-control"
                                        data-ng-options="item.value as item.name for item in model.fieldTypes"
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4 miniGroup">
                            <span>
                                <input class="form-control" type="text" data-ng-model="model.secondObj"
                                       onfocus="this.select();"
                                       placeholder="字段名"/>
                            </span>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4 miniGroup">
                            <span>
                                <input class="form-control" type="text" data-ng-model="model.remark"
                                       onfocus="this.select();"
                                       placeholder=""/>
                            </span>
                        </div>
            ...
            function ($scope, $http, $timeout, $q, $templateCache) {
                ...
                function getOracleProcSql() {
                    ...
                    if ($scope.model.operatorType == 'add' || $scope.model.operatorType == 'alter') {
                        ...
                        result = result.replace($scope.model.functionNameReg, getRemark('创建/修改存储过程')).replace($scope.model.secondNameReg, $scope.model.secondObj);
                    } else if ($scope.model.operatorType == 'delete') {
                        throw new Error('unimplement error！');
                    } else {
                        throw new Error('unimplement error！');
