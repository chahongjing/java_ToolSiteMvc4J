...
<style scoped>
  /* 默认 */
  .form-control{border:1px solid transparent;outline: none;}
  /* 正常 */
  .form-control:not(:read-only),
  .form-control:not(:disabled){border-color:#ced4da;}
  /* 正常hover */
  ...
  .input-group:active .form-control:not(:disabled){border-color:#f59942;}
  /* 禁用，只读 */
  .form-control:read-only{border-color:#ced4da;}
  .form-control:disabled{border-color:#ced4da;}
  /* 只读hover */
  .input-group:hover .form-control:read-only,
  .input-group:focus .form-control:read-only,
  .input-group:active .form-control:read-only{border-color:#f59942;}
  /* 禁用hover */
  .input-group:hover .form-control:disabled,
  .input-group:focus .form-control:disabled,
  .input-group:active .form-control:disabled{border-color:#ced4da;}


  /* 默认 */
  .form-control ~ .input-group-append .input-group-text{background-color: transparent;transition:0.3s;border-color:transparent;color:#fff;outline: none;}
  /* 正常 */
  .form-control:not(:read-only) ~ .input-group-append .input-group-text,
  .form-control:not(:disabled) ~ .input-group-append .input-group-text{background-color:#fb9271;border-color:#fb9271;}
  /* 正常hover */
  ...
  .input-group:active .form-control:not(:disabled) ~ .input-group-append .input-group-text{background-color:#ed724d;}
  /* 禁用，只读 */
  .form-control:read-only ~ .input-group-append .input-group-text{border-color:#fb9271;}
  .form-control:read-only ~ .input-group-append:last-child .input-group-text{border-left-color:#e6b280;}
  .form-control:disabled ~ .input-group-append .input-group-text{border-color:#ced4da;background-color: #d5d5d5;}
  .form-control:disabled ~ .input-group-append:last-child .input-group-text{border-left-color:#eee;}
  /* 只读hover */
  ...
  .input-group:active .form-control:read-only ~ .input-group-append .input-group-text{border-color:#f59942;}
  /* 禁用hover */
  ...
  .input-group:active .form-control:disabled ~ .input-group-append .input-group-text{border-color:#ced4da;}
</style>
