...
//ShardedJedis sjedis = getShardedJedis();
         ...
         *
         * @param newkey String 新结果集的key
         * @param keys   String... 比较的集合
         * @return 新集合中的记录数
         **/
...
//ShardedJedis sjedis = getShardedJedis();
         ...
         *
         * @param srckey String 源集合
         * @param dstkey String 目标集合
         * @param member String 源集合中的成员
         * @return 状态码，1成功，0失败
         */
         ...
         *
         * @param newkey String 新集合的key
         * @param keys   String ... 要合并的集合
         **/
...
//ShardedJedis sjedis = getShardedJedis();
         ...
         *
         * @param key    String
         * @param score  double 要增的权重
         * @param member String 要插入的值
         * @return 增后的权重
         */
...
//ShardedJedis sjedis = getShardedJedis();
         ...
         *
         * @param key   String
         * @param fieid String 存储位置
         * @param value long 要增加的值,可以是负数
...
//ShardedJedis sjedis = getShardedJedis();
         ...
         * 批量存储记录
         *
         * @param keysvalues String 例:keysvalues="key1","value1","key2","value2";
         * @return String 状态码
         */
...
//ShardedJedis sjedis = getShardedJedis();
         ...
         * @param pivot String 相对位置的内容
         * @param value String 插入的内容
         * @return 记录总数
         */
...
//ShardedJedis sjedis = getShardedJedis();
         ...
         *
         * @param key   byte[]
         * @param c     int要删除的数量，如果为负数则从List的尾部检查并删除符合的记录
         ...
         *
         * @param key   byte[]
         * @param start int记录的开始位置(0表示第一条记录)
