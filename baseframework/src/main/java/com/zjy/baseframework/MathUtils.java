...
public class MathUtils {
     ...
     * @return 两个参数的积
     */
    public static <T extends Number> double mul(double value1, double value2) {
        BigDecimal b1 = new BigDecimal(value1);
        BigDecimal b2 = new BigDecimal(value2);
     ...
     * @return 两个参数的商
     */
    public static <T extends Number> double divide(double dividend, double divisor) {
        return divide(dividend, divisor, DEF_DIV_SCALE);
    }
     ...
     * @return 两个参数的商
     */
    public static <T extends Number> double divide(double dividend, double divisor, int scale) {
        if (scale < 0) {
     ...
     * @return 四舍五入后的结果
     */
    public static <T extends Number> double round(double value, int scale) {
        if (scale < 0) {
            throw new IllegalArgumentException("The scale must be a positive integer or zero");
        }
